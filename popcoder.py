...
"""
def trim (video_name, start, duration, out):
    call(['ffmpeg', '-ss', start, '-i', video_name, '-t', duration, out])

def skip (video_name, start, duration, out):
...
"""
def draw_text (video_name, out, start, end, x, y, text, color='#FFFFFF',
...
"""
def draw_image (video_name, image_name, out, start, end, x, y):
...
if __name__ == '__main__':
    trim('big.mp4', '00:01:00', '00:02:00', 'trim.mp4')
    skip('big.mp4', 20, 10, 'skip.mp4')
    draw_text('big.mp4', 'draw_text.mp4', 10, 50, 100, 50, 'hello world')
    draw_image('big.mp4', 'cat.gif', 'draw_image.mp4', 10, 50, 100, 100)
